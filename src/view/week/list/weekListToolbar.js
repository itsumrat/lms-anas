...
class WeekListToolbar extends Component {
  doExport = () => {
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: WeekSelectors.selectPermissionToCreate(state),
    hasPermissionToImport: WeekSelectors.selectPermissionToImport(state),
  };
}

export default connect(select)(WeekListToolbar);
