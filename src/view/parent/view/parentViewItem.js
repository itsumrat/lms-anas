...
import selectors from 'modules/parent/parentSelectors';

class ParentViewItem extends Component {
    valueAsArray = () => {
...
export default connect(select)(ParentViewItem);