...
class ParentListToolbar extends Component {
  doExport = () => {
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: ParentSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: ParentSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(ParentListToolbar);
