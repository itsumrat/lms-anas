...
class CycleListToolbar extends Component {
  doExport = () => {
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: CycleSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: CycleSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(CycleListToolbar);
