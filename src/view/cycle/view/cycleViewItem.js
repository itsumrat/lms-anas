...
import selectors from 'modules/cycle/cycleSelectors';

class CycleViewItem extends Component {
    valueAsArray = () => {
...
export default connect(select)(CycleViewItem);