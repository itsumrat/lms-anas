...
import actions from 'modules/cycle/form/cycleFormActions';
import selectors from 'modules/cycle/form/cycleFormSelectors';
...
export default connect(select)(CycleForm);
