...
class LevelListToolbar extends Component {
  doExport = () => {
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: LevelSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: LevelSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(LevelListToolbar);
