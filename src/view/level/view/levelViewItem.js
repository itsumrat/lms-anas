...
import selectors from 'modules/level/levelSelectors';

class LevelViewItem extends Component {
    valueAsArray = () => {
...
export default connect(select)(LevelViewItem);