...
class ResponsibleCycleListToolbar extends Component {
  doExport = () => {
    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToImport && (
          <Link to="/responsibleCycle/importer">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: ResponsibleCycleSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: ResponsibleCycleSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(ResponsibleCycleListToolbar);
