...
import selectors from 'modules/responsibleCycle/responsibleCycleSelectors';

class ResponsibleCycleViewItem extends Component {
    valueAsArray = () => {
...
ResponsibleCycleViewItem.propTypes = {
...
export default connect(select)(ResponsibleCycleViewItem);