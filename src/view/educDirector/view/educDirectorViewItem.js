...
import selectors from 'modules/educDirector/educDirectorSelectors';

class EducDirectorViewItem extends Component {
    valueAsArray = () => {
...
EducDirectorViewItem.propTypes = {
...
export default connect(select)(EducDirectorViewItem);