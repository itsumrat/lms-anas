...
class EducDirectorListToolbar extends Component {
  doExport = () => {
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: EducDirectorSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: EducDirectorSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(EducDirectorListToolbar);
