...
import selectors from 'modules/sector/sectorSelectors';

class SectorViewItem extends Component {
    valueAsArray = () => {
...
export default connect(select)(SectorViewItem);