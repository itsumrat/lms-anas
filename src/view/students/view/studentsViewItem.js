...
import selectors from 'modules/students/studentsSelectors';

class StudentsViewItem extends Component {
    valueAsArray = () => {
...
export default connect(select)(StudentsViewItem);