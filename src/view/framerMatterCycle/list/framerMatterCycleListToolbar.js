...
class FramerMatterCycleListToolbar extends Component {
  doExport = () => {
    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToImport && (
          <Link to="/framerMatterCycle/importer">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: FramerMatterCycleSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: FramerMatterCycleSelectors.selectPermissionToImport(
      state,
    ),
  };
}
