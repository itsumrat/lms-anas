...
import selectors from 'modules/framerMatterCycle/framerMatterCycleSelectors';

class FramerMatterCycleViewItem extends Component {
    valueAsArray = () => {
...
FramerMatterCycleViewItem.propTypes = {
...
export default connect(select)(FramerMatterCycleViewItem);