...
import selectors from 'modules/schoolYear/form/schoolYearFormSelectors';
...
class SchoolYearForm extends Component {
...
export default connect(select)(SchoolYearForm);
