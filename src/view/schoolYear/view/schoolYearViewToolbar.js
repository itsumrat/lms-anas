...
class SchoolYearViewToolbar extends Component {
  id = () => {
  ...
  render() {
    ...
    return (
      <Toolbar>
        {hasPermissionToEdit && (
          <Link to={`/schoolYear/${this.id()}/edit`}>
...
function select(state) {
  return {
    ...
    hasPermissionToEdit: SchoolYearSelectors.selectPermissionToEdit(state),
...
export default connect(select)(SchoolYearViewToolbar);
