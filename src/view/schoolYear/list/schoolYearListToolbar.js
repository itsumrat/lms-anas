...
class SchoolYearListToolbar extends Component {
  doExport = () => {
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: SchoolYearSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: SchoolYearSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(SchoolYearListToolbar);
