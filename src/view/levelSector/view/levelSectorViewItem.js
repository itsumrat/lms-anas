...
import selectors from 'modules/levelSector/levelSectorSelectors';

class LevelSectorViewItem extends Component {
    valueAsArray = () => {
...
export default connect(select)(LevelSectorViewItem);