...
class LevelSectorListToolbar extends Component {
  doExport = () => {
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: LevelSectorSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: LevelSectorSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(LevelSectorListToolbar);
