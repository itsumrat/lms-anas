...
class ClassroomListToolbar extends Component {
  doExport = () => {
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: ClassroomSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: ClassroomSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(ClassroomListToolbar);
