...
import selectors from 'modules/classroom/classroomSelectors';

class ClassroomViewItem extends Component {
    valueAsArray = () => {
...
export default connect(select)(ClassroomViewItem);