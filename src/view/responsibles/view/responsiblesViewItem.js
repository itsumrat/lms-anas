...
import selectors from 'modules/responsibles/responsiblesSelectors';

class ResponsiblesViewItem extends Component {
    valueAsArray = () => {
...
ResponsiblesViewItem.propTypes = {
...
export default connect(select)(ResponsiblesViewItem);