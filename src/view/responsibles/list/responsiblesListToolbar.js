...
class ResponsiblesListToolbar extends Component {
  doExport = () => {
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: ResponsiblesSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: ResponsiblesSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(ResponsiblesListToolbar);
