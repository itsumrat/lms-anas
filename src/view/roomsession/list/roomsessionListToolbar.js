...
class RoomsessionListToolbar extends Component {
  doExport = () => {
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: RoomsessionSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: RoomsessionSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(RoomsessionListToolbar);
