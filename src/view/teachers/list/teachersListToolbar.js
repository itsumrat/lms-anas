...
class TeachersListToolbar extends Component {
    doExport = () => {
        ...
        return (
            <Toolbar>
                ...
                {this.props.hasPermissionToAuditLogs && (
                    <Link to="/audit-logs?entityNames=teachers">
...
function select(state) {
    return {
        ...
        hasPermissionToCreate: TeachersSelectors.selectPermissionToCreate(
            state,
        ),
        hasPermissionToImport: TeachersSelectors.selectPermissionToImport(
            state,
        ),
    };
}

export default connect(select)(TeachersListToolbar);