...
import selectors from 'modules/teachers/teachersSelectors';

class TeachersViewItem extends Component {
    valueAsArray = () => {
...
export default connect(select)(TeachersViewItem);