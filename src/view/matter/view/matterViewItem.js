...
import selectors from 'modules/Matter/matterSelectors';

class MatterViewItem extends Component {
    valueAsArray = () => {
...
export default connect(select)(MatterViewItem);