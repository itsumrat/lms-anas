...
import actions from 'modules/matter/form/matterFormActions';
import selectors from 'modules/matter/form/matterFormSelectors';
...
export default connect(select)(MatterForm);