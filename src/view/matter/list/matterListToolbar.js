...
import actions from 'modules/matter/list/matterListActions';
...
class MatterListToolbar extends Component {
  doExport = () => {
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: MatterSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: MatterSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(MatterListToolbar);
