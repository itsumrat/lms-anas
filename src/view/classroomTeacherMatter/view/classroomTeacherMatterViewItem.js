...
class ClassroomTeacherMatterViewItem extends Component {
    valueAsArray = () => {
...
ClassroomTeacherMatterViewItem.propTypes = {
...
export default connect(select)(ClassroomTeacherMatterViewItem);