...
class ClassroomTeacherMatterListToolbar extends Component {
  doExport = () => {
    ...
    return (
      <Toolbar>
        {this.props.hasPermissionToCreate && (
          <Link to="/classroomTeacherMatter/new">
        ...
        {this.props.hasPermissionToImport && (
          <Link to="/classroomTeacherMatter/importer">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: ClassroomTeacherMatterSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: ClassroomTeacherMatterSelectors.selectPermissionToImport(
      state,
    ),
  };
}
