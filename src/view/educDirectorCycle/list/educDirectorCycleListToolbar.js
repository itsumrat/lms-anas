...
class EducDirectorCycleListToolbar extends Component {
  doExport = () => {
    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToImport && (
          <Link to="/educDirectorCycle/importer">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: EducDirectorCycleSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: EducDirectorCycleSelectors.selectPermissionToImport(
      state,
    ),
  };
}
