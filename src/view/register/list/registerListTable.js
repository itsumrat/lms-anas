...
class RegisterListTable extends Component {
  ...
  columns = [
    ...
    fields.student.forTable({
      render: (_, record) => {
        return <StudentsListItem value={record.student} />;
      },
    }),
      ...
      render: (_, record) => (
        <div className="table-actions">
          ...
          {this.props.hasPermissionToEdit && (
            <Link to={`/register/${record.id}/edit`}>
              {i18n('common.edit')}
            </Link>
          )}
...
export default connect(select)(RegisterListTable);
