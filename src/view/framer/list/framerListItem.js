...
import selectors from 'modules/framer/framerSelectors';

class FramerListItem extends Component {
  valueAsArray = () => {
...
export default connect(select)(FramerListItem);
