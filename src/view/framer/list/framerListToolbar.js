...
class FramerListToolbar extends Component {
  doExport = () => {
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: FramerSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: FramerSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(FramerListToolbar);
