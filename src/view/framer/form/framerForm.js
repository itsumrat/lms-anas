...
import actions from 'modules/framer/form/framerFormActions';
import selectors from 'modules/framer/form/framerFormSelectors';
...
class FramerForm extends Component {
...
export default connect(select)(FramerForm);
