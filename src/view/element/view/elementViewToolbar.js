...
class ElementViewToolbar extends Component {
  id = () => {
...
function select(state) {
  return {
    ...
    hasPermissionToEdit: ElementSelectors.selectPermissionToEdit(state),
    hasPermissionToDestroy: ElementSelectors.selectPermissionToDestroy(state),
    destroyLoading: destroySelectors.selectLoading(state),
  };
}

export default connect(select)(ElementViewToolbar);
