...
class ElementListToolbar extends Component {
  doExport = () => {
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: ElementSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: ElementSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(ElementListToolbar);
